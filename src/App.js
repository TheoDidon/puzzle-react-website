...
function App() {
    return (
        <div className="no-scrollbar flex flex-col h-screen overflow-x-hidden">
            <button className="fixed right-[3rem] bottom-[12rem] bg-black text-white text-xs font-bold px-[1.2rem] py-[0.5rem] rounded-full border border-white border-[0.2rem] z-999">Forum</button>
            <Navbar />
            <BlackBanner />
            <MainText />
